 ...
 */
class FhaycsalmafuerteState extends State
{
  const ENTRE_RIOS = 3; 

}

class FhaycsalmafuerteCity extends City
{
  const LA_PICADA = 2178;
}

class FhaycsalmafuerteSchoolBehaviour extends BaseSchoolBehaviour
{
  protected $school_name = "Escuela Normal Rural Almafuerte";
  ...
  {
    return FhaycsalmafuerteState::ENTRE_RIOS;

  }

  public function getDefaultCityId()
  {
    return FhaycsalmafuerteCity::LA_PICADA;
