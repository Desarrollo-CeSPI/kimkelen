...
<div class="report-header">
  ...
  <div class="header_row">
    ...
    <div class="header_right">
      <?php /* <div class="school_year"><?php echo $division->getSchoolYear()?></div> */ ?>
      ...
      <div class="division"><?php echo $division->getDivisionTitle(); ?></div>
        ...
        <div class="title"><?php echo SchoolBehaviourFactory::getInstance()->getOrientationText($student_career->getCareer()); ?>: </div>

        <div class="orientation"><?php echo (($student_career->getOrientation()) ? $student_career->getOrientation() : '-'); ?></div>
        <?php if ($student_career->getSubOrientation()): ?>
        <div class="title"><?php echo SchoolBehaviourFactory::getInstance()->getSubOrientationText($student_career->getCareer()); ?>: </div>
        <div class="orientation"><?php echo (($student_career->getSubOrientation()) ? $student_career->getSubOrientation() : '-'); ?></div>
      <?php endif ?>
    </div>
  </div>
</div>