...
class BbaStudentForm extends StudentForm
{
  ...
  {
    $personal_data_fields = array('person-lastname', 'person-firstname', 'person-identification_type', 'person-identification_number', 'global_file_number','origin_school', 'educational_dependency', 'person-sex', 'person-cuil', 'person-birthdate', 'person-photo', 'person-observations' );
