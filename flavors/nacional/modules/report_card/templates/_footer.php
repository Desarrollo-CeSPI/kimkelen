...
<div class="colsleft">
  <?php if ($division->hasCourseType(CourseType::TRIMESTER)): ?>
    ...
    <?php endif ?>
    <div class="rowcom">
      <div class="titletable"><?php echo __('Historical sanctions') ?></div>
      <table class="lefttable">
        <?php $sanctions = StudentDisciplinarySanctionPeer::retrieveHistoricalStudentDisciplinarySanction($student, $division->getSchoolYear()); ?>
        <?php foreach ($sanctions as $sanction):?>
        <tr>
          <td><?php echo $sanction->getSanctionType() . " (".  format_date($sanction->getRequestDate(), "dd/MM/yyyy") . ")"; ?></td>
          <td><?php echo $sanction->getValue(); ?></td>     
        </tr>
        <?php endforeach; ?>
      </table>
    </div>
