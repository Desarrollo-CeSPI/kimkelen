  ...
  <div class="article-div">
    ...
    <div class="article-div">
      ...
      <span class="little-box">
        <?php echo $record->countRecordDetailsForSheet() ?>
      </span>

      <strong><?php echo __('Aprobados'); ?>:</strong>
      <span class="little-box">
        <?php echo $record->countRecordDetailsForSheetAndResult(NULL,$evaluator_instance->getApprovedResult()) ?>
      </span>

      <strong><?php echo __('Aplazados'); ?>:</strong>
      <span class="little-box">
        <?php echo $record->countRecordDetailsForSheetAndResult(NULL,$evaluator_instance->getDisapprovedResult()) ?>
      </span>
