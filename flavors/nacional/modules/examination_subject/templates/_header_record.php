...
<div class="record-header">
  ...
  <div class="white-background"><?php echo 'Exámenes de Alumnos: ' . $examination_subject->getExamination() ; ?> - <?php echo $examination_subject->getCareerSubjectSchoolYear()->getCareerSubject()->getCareer()->getCareerName()?></div>
