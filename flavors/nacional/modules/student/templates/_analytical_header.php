...
<div class="report-header">
    <div class="header_row">
        ...
        <div class="title" id="header_analytical_data_center">
            <?php echo image_tag("logo_nacional_bn.png", array( 'class'=>'school_logo', 'absolute' => true)) ?>
            <h1><?php echo __('Colegio Nacional Rafael Hernández') ?> <small><?php echo __("Universidad Nacional de La Plata") ?></small></h1>
        </div>
