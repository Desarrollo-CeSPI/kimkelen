...
<div>
    <p class="header-text"> El/La director/a del
        ...
        proveniente de <span><?php echo ($student->getOriginSchool()?$student->getOriginSchool()->getName():__('otra escuela')); ?></span> donde finalizó sus estudios de <?php echo __('nombre_ultimo_anio_primario'); ?> y aprobó en este Establecimiento las asignaturas que con sus respectivas notas se expresan:
    </p>
</div>
