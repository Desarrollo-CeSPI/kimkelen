...
<div>
    <p class="header-text"> La directora del
        ...
        <?php echo ($initial_scsy > 1 )? __($initial_scsy -1) . '° año de la ESB': __('nombre_ultimo_anio_primario'); ?>  y aprobó en este Establecimiento las asignaturas que con sus respectivas notas se expresan:
    </p>
</div>
