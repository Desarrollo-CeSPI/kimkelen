...
class LvmStudentForm extends StudentForm
{
  ...
  {
    $personal_data_fields = array('person-lastname', 'person-firstname', 'person-identification_type', 'person-identification_number','origin_school_id', 'global_file_number','person-sex', 'person-cuil', 'person-birthdate', 'person-birth_country', 'person-birth_state','person-birth_department' ,'person-birth_city','person-nationality_id' ,'person-photo', 'person-observations' );
