 ...
 */
class FhaycsnormalState extends State
{
  const ENTRE_RIOS = 3; 

}

class FhaycsnormalCity extends City
{
  const PARANA = 2059;
}

class FhaycsnormalSchoolBehaviour extends BaseSchoolBehaviour
{
  protected $school_name = "Escuela Normal J.M.T.";
  ...
  {
    return FhaycsnormalState::ENTRE_RIOS;

  }

  public function getDefaultCityId()
  {
    return FhaycsnormalCity::PARANA;
