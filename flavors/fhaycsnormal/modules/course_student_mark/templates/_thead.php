...
<thead>
  <tr>
    ...
    <th align="center" rowspan="2"><?php echo __('Average') ?></th>

    <th align="center" rowspan="2"><?php echo __('Dic.') ?></th>
    <th align="center" rowspan="2"><?php echo __('Feb.') ?></th>
    <th align="center" rowspan="2"><?php echo __('Mar.') ?></th>
    <th align="center" rowspan="2"><?php echo __('Asignaturas pendientes') ?></th>
    <th align="center" rowspan="2"><?php echo __('Promedio def.') ?></th>

    <th align="center" rowspan="2" style="width: 20%"><?php echo __('Observation') ?></th>
  </tr>
