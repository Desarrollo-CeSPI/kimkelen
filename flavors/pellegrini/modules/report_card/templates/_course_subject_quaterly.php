...
<table class="gridtable">
  ...
  <?php foreach ($course_subject_students as $course_subject_student): ?>
    <tr>
      ...
      <td><?php echo $course_subject_student->getMarkFor(4) ?></td>
      ...
      <td><?php echo (($course_result instanceOf StudentDisapprovedCourseSubject) && $course_subject_student_examination = $course_subject_student->getCourseSubjectStudentExaminationsForExaminationNumber(3)) ? $course_subject_student_examination->getMarkStr() : '' ?></td>
      <td><?php echo (($course_result instanceOf StudentDisapprovedCourseSubject) && $course_subject_student_examination = $course_subject_student->getCourseSubjectStudentExaminationsForExaminationNumber(4)) ? $course_subject_student_examination->getMarkStr() : '' ?></td>
      ...
      <td>
        ...
        <?php else:?>
          <?php echo ($student_approved_course_subject = $course_subject_student->getStudentApprovedCareerSubject()) ? $student_approved_course_subject->getMark() : '';?>
        <?php endif ?>
      </td>
