...
ALTER TABLE `student_attendance` DROP INDEX student_attendance_unique, ADD UNIQUE INDEX `student_attendance_unique` (`student_id`, `day`, `course_subject_id`), CHANGE `attendance_type` `attendance_type` INTEGER  NOT NULL COMMENT 'Define si una asistencia es por dia o por materia.';
