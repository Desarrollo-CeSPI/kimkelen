...
ALTER TABLE `student_examination_repproved_subject` ADD `folio_number` VARCHAR(20) COMMENT 'Número de folio del examen', ADD UNIQUE INDEX `sers_unique` (`student_repproved_course_subject_id`, `examination_repproved_subject_id`), DROP INDEX student_examination_repproved_subject_FI_1;
