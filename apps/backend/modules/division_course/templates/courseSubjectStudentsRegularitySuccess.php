...
<div id="sf_admin_container">
  <h1>
    <?php echo __('Manage Students Regularity for %%course_name%%', array('%%course_name%%' => $course)) ?>
  </h1>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('division_course/courseSubjectStudentsRegularity') ?>" method="post">
      <ul class="sf_admin_actions">
        <li><?php echo link_to(__('Back'), '@division_course', array('class' => 'sf_admin_action_go_back')) ?></li>
      ...
      <?php else: ?>
        <?php echo __('The course has no students.'); ?>
      <?php endif; ?>
      <ul class="sf_admin_actions">
        <li><?php echo link_to(__('Back'), '@division_course', array('class' => 'sf_admin_action_go_back')) ?></li>
        <li><input type="submit" value="<?php echo __('Save') ?>" /></li>
