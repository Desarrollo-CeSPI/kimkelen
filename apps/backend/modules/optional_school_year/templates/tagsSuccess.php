...
<div id="sf_admin_container">
  <h1><?php echo __('Etiquetas de la optativa %career_subject_school_year%', array('%career_subject_school_year%' => $career_subject_school_year->__toString())) ?></h1>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('career_subject_school_year/updateTags') ?>" method="post">
      <ul class="sf_admin_actions">
        <li><?php echo link_to(__('Volver al listado de optativas'), '@optional_school_year', array('class' => 'sf_admin_action_go_back')) ?></li>
