...
<div id="sf_admin_container">
  <h1><?php echo __('Course configuration of the %division%', array('%division%' => $division->getName())) ?></h1>

  <div id="sf_admin_content">
    <form action=<?php echo url_for('division/updateCourseConfiguration') ?> method="post">

      <input type="hidden" name="id" value="<?php echo $division->getId() ?>" />

      <div>
        <h2><?php echo __('Absences by period') ?></h2>
      </div>
        <fieldset id="course_sbuject_configuration_fieldset_<?php echo $division->getId() ?>" class="course_sbuject_configuration_fieldset">
          <?php echo $form ?>
        </fieldset>
