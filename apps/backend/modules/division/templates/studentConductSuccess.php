...
<div id="sf_admin_container">
  <h1><?php echo __('Conduct of the students to the %division%', array('%division%' => $division->__toString())) ?></h1>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('division/updateConduct') ?>" method="post">
      <input type="hidden" name="division_id" id="division_id" value=<?php echo $division->getId()?>>
      ...
      <fieldset>
        <?php include_partial('print_form',array('form' => $form, 'students'=>$students, 'division'=>$division,'periods'=>$periods ));?>
      </fieldset>
      <ul class="sf_admin_actions">
        <li><?php echo link_to(__('Back'), '@division', array('class' => 'sf_admin_action_go_back')) ?></li>
        <li><input type="submit" value="<?php echo __('Save') ?>" /></li>
