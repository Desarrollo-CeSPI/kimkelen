...
<div id="sf_admin_container">
  <h1><?php echo __('Preceptors division configuration of %division%', array('%division%' => $division->__toString())) ?></h1>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('division/updateDivisionPreceptors') ?>" method="post">
      ...
      <fieldset>
        ...
        <h2><?php echo __('Preceptors division configuration') ?></h2>
        <?php echo $form?>
