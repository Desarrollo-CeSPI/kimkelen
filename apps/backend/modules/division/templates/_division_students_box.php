 ...
 */ ?>
<?php $has_students = $division->countDivisionStudents()?>
<span class="attribute <?php !$has_students and print 'disabled' ?>"><?php echo __('Tiene alumnos inscriptos') ?> <?php echo ($has_students ) ? "(".$has_students .") <em>No será posible eliminar la division</em>" : "" ?></span>
  ...
  <?php if ($has_students): ?>
    ...
    <?php echo link_to_function(__('&gt; Ver alumnos'),"jQuery('#division_students_".$division->getId()."').toggle();",array('class' => 'show-more-link', 'id' => "division_students_".$division->getId()."_show", 'style' => 'display: none', 'title' => __('Desplegar todos los alumnos inscriptos en ésta división'))) ?>
