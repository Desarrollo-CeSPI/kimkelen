...
<div id="sf_admin_container">
  <h1><?php echo __('Move students from division %division%', array('%division%' => $origin_division->__toString())) ?></h1>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('division/updateMoveStudents') ?>" method="post">
      ...
      <input type="hidden" name="id" value="<?php echo $origin_division->getId() ?>" />
      <fieldset>
        <?php echo $form?>
      </fieldset>
