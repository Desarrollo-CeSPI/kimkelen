...
<div id="sf_admin_container">
  <h1><?php echo __('Calification of the students to the %final_examination_subject%', array('%final_examination_subject%' => $final_examination_subject->getSubject())) ?></h1>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('final_examination_subject/updateCalifications') ?>" method="post">
      ...
      <fieldset>
        <h2><?php echo __('Calification') ?></h2>
        <?php echo $form->renderHiddenFields();?>
        <?php echo $form->renderGlobalErrors();?>
        <?php include_partial('notes', array('form' => $form))?>        
      </fieldset>
