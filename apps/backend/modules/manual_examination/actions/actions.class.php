...
require_once dirname(__FILE__).'/../lib/manual_examinationGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/manual_examinationGeneratorHelper.class.php';
 ...
 */
class manual_examinationActions extends autoManual_examinationActions
{
  /**
