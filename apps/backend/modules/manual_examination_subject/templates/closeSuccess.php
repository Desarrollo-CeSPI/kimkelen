...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
    <form action="<?php echo url_for('manual_examination_subject/realClose') ?>" method="post">
      ...
      <ul class="sf_admin_actions">
        <li><?php echo link_to(__('Back'), '@manual_examination_subject', array('class' => 'sf_admin_action_go_back')) ?></li>
        <li><input type="submit" value="<?php echo __('Confirm') ?>" onCLick="return (confirm('¿Está seguro?'));" /></li>
      </ul>
    </form>
  </div>
