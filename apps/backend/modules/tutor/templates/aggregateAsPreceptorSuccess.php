...
<div id="sf_admin_container">
  <h1><?php echo __('Generate profile preceptor for tutor %tutor%', array("%tutor%" => $tutor->getPerson()->getFullName())) ?></h1>
  <div id="sf_admin_content">
    <form action="<?php echo url_for('@tutor_aggregate_preceptor') . '?id='.$tutor->getId()?>" method="post">
