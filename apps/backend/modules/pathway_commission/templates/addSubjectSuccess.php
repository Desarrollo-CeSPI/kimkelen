 ...
 <?php if (!empty($course_subjects)): ?>
      ...
      <table>
        <?php foreach ($course_subjects as $course_subject):?>
          <tr>
            ...
            <td><?php echo link_to(__('Delete'), "pathway_commission/deleteSubject?id=" . $course->getId() . "&course_subject_id=" . $course_subject->getId())?></td>
          </tr>
        <?php endforeach?>
      </table>
    </div>
  ...
  <div id="sf_admin_content">
    <div class="sf_admin_form">
      <form action="<?php echo url_for('pathway_commission/addSubject') ?>" method="post" >
        ...
        <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
          <fieldset id="sf_fieldset_<?php echo preg_replace('/[^a-z0-9_]/', '_', strtolower($fieldset)) ?>">
            ...
            <?php foreach ($fields as $name => $field): ?>
              ...
              <?php
              include_partial('pathway_commission/form_field', array(
                'name' => $name,
        ...
        <ul class="sf_admin_actions">
          ...
          <li class ="sf_admin_action_list"><?php echo link_to(__('Back'), 'pathway_commission'); ?></li>
