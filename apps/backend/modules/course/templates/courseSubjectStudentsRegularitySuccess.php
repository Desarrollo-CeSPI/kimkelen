...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
    <form action="<?php echo url_for('course/courseSubjectStudentsRegularity') ?>" method="post">
      <ul class="sf_admin_actions">
        <li><?php echo link_to(__('Back'), '@course', array('class' => 'sf_admin_action_go_back')) ?></li>
