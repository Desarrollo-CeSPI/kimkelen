...
<div id="sf_admin_container">
  <h1><?php echo __('Manage preceptors of %course%', array('%course%' => $course)) ?></h1>

  <div id="sf_admin_content">

    <h2><?php echo __("Preceptors of %course%", array("%course%" => $course)) ?></h2>

    <form action="<?php echo url_for('course/updatePreceptors') ?>" method="post">
