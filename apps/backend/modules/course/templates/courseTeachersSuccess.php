...
<div id="sf_admin_container">
  <h1><?php echo __('Manage teachers of %course%', array('%course%' => $course)) ?></h1>

  <div id="sf_admin_content">

    <h2><?php echo __("Teachers of %course%", array("%course%" => $course)) ?></h2>

    <form action="<?php echo url_for('course/updateTeachers') ?>" method="post">
