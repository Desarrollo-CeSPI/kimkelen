...
<div id="sf_admin_container">
  <h1><?php echo __('Choose student to revert calificate without numerical mark from %course%', array('%course%' => $course)) ?></h1>
  <div class="sf_admin_form">
    <form action="<?php echo url_for('@save_revert_calificate_non_numerical_mark') ?>" method="post">
