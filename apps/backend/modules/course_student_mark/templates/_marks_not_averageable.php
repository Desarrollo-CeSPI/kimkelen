...
<?php foreach ($course_subject_students as $course_subject_student): ?>
  <div class="sf_admin_form_row">
    ...
    <div>
      ...
      <?php include_component('course_student_mark', 'mark_not_averageable', array('form' => $form, 'course_subject_student' => $course_subject_student, 'course_subject' => $course_subject, 'configuration' => $configuration)); ?>
