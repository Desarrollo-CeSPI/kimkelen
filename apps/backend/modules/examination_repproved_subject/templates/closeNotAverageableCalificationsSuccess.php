...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
    <form action="<?php echo url_for('examination_repproved_subject/realCloseNotAverageableCalifications') ?>" method="post">
        ...
        <table>
          ...
          <?php foreach ($examination_repproved_subject->getSortedStudentExaminationRepprovedSubjects() as $student_examination_repproved_subject): ?>
            <tr class="<?php echo $student_examination_repproved_subject->getResultClass() ?>">
              ...
              <td><?php echo $student_examination_repproved_subject->getNotAverageableMark() ? BaseCustomOptionsHolder::getInstance('NotAverageableCalificationType')->getStringFor($student_examination_repproved_subject->getNotAverageableMark()) : __("Is absent") ?></td>
              <td><?php echo BaseCustomOptionsHolder::getInstance('NotAverageableCalificationType')->getStringFor($student_examination_repproved_subject->getNotAverageableMark()) ?></td>
            </tr>
          <?php endforeach ?>
        </table>
      </fieldset>
