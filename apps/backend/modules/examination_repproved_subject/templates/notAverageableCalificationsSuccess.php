...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
    <form action="<?php echo url_for('examination_repproved_subject/updateNotAverageableCalifications') ?>" method="post">
        ...
        <?php foreach ($forms as $form): ?>
          <div class="sf_admin_form_row">
            <div style="min-height: 75px;"> 
              ...
              <?php echo $form["id"] ?>
              <?php echo $form["not_averageable_mark"]->renderError() ?>
              <?php echo $form["not_averageable_mark"]->renderLabel() ?>
              <?php echo 'Nota: ' . $form["not_averageable_mark"] ?>
              <?php if (isset($form["is_absent"])): ?>
                <?php echo $form["is_absent"] ?><span style="margin-left: 10px"><?php echo __("Is absent") ?>?</span>
              <?php endif ?>
              <div class="help">
                <?php echo $form["not_averageable_mark"]->renderHelp() ?>
              </div>
