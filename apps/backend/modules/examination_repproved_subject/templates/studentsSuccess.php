...
<div id="sf_admin_container">
  <h1><?php echo __('Inscription of the students to the %examination_repproved_subject%', array('%examination_repproved_subject%' => $examination_repproved_subject->getCareerSubject())) ?></h1>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('examination_repproved_subject/updateStudents') ?>" method="post">
      ...
      <fieldset>
        <h2><?php echo __('Inscription of students to the examination repproved subject') ?></h2>
        <?php echo $form?>
      </fieldset>
