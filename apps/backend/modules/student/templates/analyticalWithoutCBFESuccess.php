...
<div id="sf_admin_container">
    ...
    <ul class="sf_admin_actions">
        ...
        <li class="sf_admin_action_print">
            <?php echo link_to(__('Pantalla de  impresión', array(), 'messages'), 'student/printAnalyticalWithoutCBFE?id=' . $career_student->getId().'&orientation=Portrait') ?>
        </li>
    </ul>
    
<div class="analytical">
    <?php include_partial('analyticalWithoutCBFE_header', array('career_student' => $career_student, 'analytical' => $analytical)) ?>
    <div class="report-content">
        <?php include_component('student', 'component_analytical_tableWithoutCBFE', array('career_student' => $career_student)) ?>
    </div>
