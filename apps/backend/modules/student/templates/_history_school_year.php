...
<div class="history_school_year">
  ...
  <?php isset($course_subject_students['ANUAL'])? include_partial("student/current_course_subjects",
          array("course_subject_students" => $course_subject_students['ANUAL'],
                'career_student' => $career_student,
                'back_url'=> $back_url,
                'student' => $student,
                'course_type' =>  CourseType::TRIMESTER)) : ''?>

  <?php isset($course_subject_students['QUATERLY'])? include_partial("student/current_course_subjects",
          array("course_subject_students" => $course_subject_students['QUATERLY'],
                'career_student' => $career_student,
                'back_url' => $back_url,
                'student' => $student,
                'course_type' =>  CourseType::QUATERLY)):''?>

  <?php isset($course_subject_students['BIMESTER'])? include_partial("student/current_course_subjects",
          array("course_subject_students" => $course_subject_students['BIMESTER'],
                'career_student' => $career_student,
                'back_url' => $back_url,
                'student' => $student,
