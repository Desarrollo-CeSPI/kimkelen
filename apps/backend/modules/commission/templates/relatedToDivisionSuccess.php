...
<div id="sf_admin_container">
  <h1>
    <?php echo __('Relate a division for a commission %%course_name%%', array('%%course_name%%' => $course)) ?>
  </h1>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('commission/relatedToDivision') ?>" method="post">
