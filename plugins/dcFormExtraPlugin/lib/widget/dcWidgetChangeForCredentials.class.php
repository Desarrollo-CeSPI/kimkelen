<?php
/**
 * dcWidgetChangeForCredentials represents widget that shows diferent components 
...
class dcWidgetChangeForCredentials extends sfWidgetForm {
  /**
   * Constructor.
   *
   * Available options:
...
EOF
  ...
  {
    return array('/dcFormExtraPlugin/js/dcWidgetChangeForCredentials.js');
  }
