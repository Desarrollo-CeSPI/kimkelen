<?php
/**
 * dcWidgetAjaxDependence is a widget that depends on other widget
...
class dcWidgetAjaxDependence extends sfWidgetForm
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('observed_boolean_widget_has_empty',false);
    $this->addOption('observe_callback',url_for('@dcWidgetAjaxDependenceChanged'));
  ...
  {
    return array_merge(parent::getJavascripts(),array('/dcFormExtraPlugin/js/dcWidgetAjaxDependence.js'), $this->getDependantWidgetJavascripts());
  }
  ...
  public function getJavascript($update_element)
  {
    ...
    return javascript_tag("dcWidgetAjaxDependence.add(
        '$my_id',
        '$observe_id',
        '$event_type',
        '$ajax_url',
  ...
  {
    $id=$this->getId();
    return javascript_tag("dcWidgetAjaxDependence.updateDependencies('$id');");
  }
  ...
  public function ajaxRender($observed_value=null)
  {
    ...
    if ($this->getOption('observe_widget_is_boolean') && $this->getOption('observed_boolean_widget_has_empty') && in_array($observed_value, array('', null)))
    {
