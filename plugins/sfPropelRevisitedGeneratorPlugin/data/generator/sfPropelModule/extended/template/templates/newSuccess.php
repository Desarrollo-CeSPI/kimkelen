...
<div id="sf_admin_container">
  ...
  [?php include_partial('<?php echo $this->getModuleName() ?>/form_slot_actions', array('<?php echo $this->getSingularName() ?>' => $<?php echo $this->getSingularName() ?>, 'form' => $form, 'helper' => $helper)) ?]
