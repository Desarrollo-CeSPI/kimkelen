...
class sfGuardSecurityUser extends sfBasicSecurityUser
{
  ...
  {
	  return $this->getGuardUser() ? $this->getGuardUser()->getUsername() : "SIPECU";
  }
  ...
  public function changePassword($password, $con = null)
  {
    $this->getGuardUser()->setPassword($password);
    $this->getGuardUser()->setMustChangePassword(false);
    $this->getGuardUser()->setChangePasswordAt(time());
    $this->getGuardUser()->save($con);
  }
