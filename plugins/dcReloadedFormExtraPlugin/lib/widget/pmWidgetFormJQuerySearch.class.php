 ...
 */
class pmWidgetFormJQuerySearch extends sfWidgetForm
{
  /**
...
EOF
  ...
  {    
    ...
    $html = strtr($search_template, array(
      ...
      "%search_label%" => $this->translate($this->getOption("search_label")),
      "%selected_label%" => $this->translate($this->getOption("selected_label")),
...
EOF;
    ...
    return strtr($tpl, array(
      ...
      "%no_results_found_label%" => $this->translate($this->getOption("no_results_found_label")),
