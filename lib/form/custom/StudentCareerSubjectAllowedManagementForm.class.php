...
class StudentCareerSubjectAllowedManagementForm extends StudentForm
{
  ...
  {
    unset(
      $this['student_career_subject_allowed_list'], $this["global_file_number"], $this["person_id"], $this["occupation_id"], $this["busy_starts_at"], $this["blood_group"], $this["blood_factor"], $this["emergency_information"], $this["health_coverage_id"], $this["student_tag_list"], $this["busy_ends_at"]
    );
