 ...
 * @author mbrown
 */
class CourseSubjectStudentsRegularityForm extends sfForm {

  private $course;

  public function configure()
  {
    $this->widgetSchema->setNameFormat('course_subject_students_regularity[%s]');
  ...
  {
    $this->course = $course;
    $course_subject_students = $course->getCourseSubjectStudents();
  ...
  public function save($con = null)
  {
    ...
    try
    {
      ...
      foreach ($this->course->getCourseSubjectStudents() as $course_subject_student)
      {
