...
/**
 * StructureReportsForm
 *
 * @author María Emilia Corrons <ecorrons@cespi.unlp.edu.ar>
 */
class StructureReportsForm extends sfForm
{
  public function configure()
  {
    ...
    $this->getWidgetSchema()->setNameFormat('structure_reports[%s]');
  ...
  public function configureWidgets()
  {
    ...
    $this->setWidget('year', new dcWidgetAjaxDependence(array(
        'dependant_widget' => $w,
        'observe_widget_id' => 'structure_reports_career_school_year_id',
    ...
    $this->setWidget('division_id', new dcWidgetAjaxDependence(array(
        ...
        'observe_widget_id' => 'structure_reports_year',
        "message_with_no_value" => "Seleccione una carrera y un año",
        'get_observed_value_callback' => array(get_class($this), 'getDivisions')
      )));

    $shift_widget = new sfWidgetFormPropelChoice(array('model' => 'Shift', 'add_empty' => true));
    $this->setWidget('shift_id', new dcWidgetAjaxDependence(array(
        'dependant_widget' => $shift_widget,
        'observe_widget_id' => 'structure_reports_division_id',
        "message_with_no_value" => "Seleccione una división",
        'get_observed_value_callback' => array(get_class($this), 'getShifts')
      )));
  }
  ...
  public static function getShifts($widget, $values)
  {
    $c = new Criteria();
