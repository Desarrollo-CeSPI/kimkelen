...
class CareerStudent extends BaseCareerStudent
{
  ...
  public function deleteCourseSubjectStundentExaminationByCareerSchoolYear($career_school_year)
  {
    $con = Propel::getConnection();
    ...
    try
    {
      ...
      foreach (CourseSubjectStudentExaminationPeer::doSelect($criteria) as $course_subject_student_examination)
      {
  ...
  public function deleteDespprovedCourseSubjectStundentByCareerSchoolYear($career_school_year)
  {
	  ...
	  $con = Propel::getConnection();
		...
		try
		{
		  ...
		  foreach (StudentDisapprovedCourseSubjectPeer::doSelect($criteria) as $student_disapproved_course_subject)
		  {
			$student_disapproved_course_subject->delete($con);
		  }
  ...
  public function deleteRepprovedCourseSubjectStudentByCareerSchoolYear($career_school_year)
  {
	   $con = Propel::getConnection();
		...
		try
		{
		  ...
		  foreach (StudentRepprovedCourseSubjectPeer::doSelect($criteria) as $student_repproved_course_subject)
		  {
