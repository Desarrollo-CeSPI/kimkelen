...
class dcAbsenceTypeOrderTask extends sfBaseTask
{
  protected function configure()
  {
    ...
    $this->namespace        = 'dc';
    $this->name             = 'absenceTypeOrder';
    $this->briefDescription = '';
    $this->detailedDescription = <<<EOF
The [dc:absenceTypeOrder|INFO] task does things.
Call it with:

  [php symfony dc:absenceTypeOrder|INFO]
EOF;
  }
